...
output "SomeOutput" {
  value = <<EOF
        ...
        Machine1 uses following key pair        ${aws_key_pair.test_key.key_name}
        ...
        Machine2 uses following key pair        ${aws_key_pair.test_key.key_name}
        ...
        Machine3 uses following key pair        ${aws_key_pair.test_key.key_name}
